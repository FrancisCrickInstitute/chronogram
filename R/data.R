#' Small study
#'
#' A fictional covid-19 vaccine study of 3 individuals
#'
#' @format ## `smallstudy`
...
#' https://data.mendeley.com/datasets/fyp26zjgmj/1 Published: 3
#' November 2021, DOI: 10.17632/fyp26zjgmj.1. Contributors: Rebecca
#' Payne, Susan Hopkins, Victoria Hall, Christina Dold, Christopher
#' Duncan, Alex Richter, Miles Carroll, Gavin Screaton, Thushan de
#' Silva, Lance Turtle, Paul Klenerman, Susanna Dunachie, PITCH
#' Consortium authors.
#'
...
#' (DOI: 10.17632/fyp26zjgmj.1). 1. the public data reports dates as
...
#' DD/MM/YYYY dates - they are not real. 2. not all of the public
...
#' reasons, do not use this example dataset. Instead consult the
#' de-identified Mendeley data (DOI: 10.17632/fyp26zjgmj.1), or the
#' Cell manuscript's data and code availability statement.
#'
